...
export const getBrevoParamsFromFeedback = (feedback: Feedback) => {
  const params = {
    type: feedback.type,
    name: 'name' in feedback ? feedback.name : undefined,
    category:
      ...
      feedback.type === FeedbackType.Bug
        ? feedback.category
        : undefined,
    message: 'message' in feedback ? feedback.message : undefined,
    operatingSystem: feedback.operatingSystem,
    device: feedback.device,
    appVersion: feedback.appVersion,
    rating: 'rating' in feedback ? feedback.rating : undefined,
